...
function ProfileScreen(props) 
{
	...
	useEffect(()=>{
		fetch('http://192.168.8.100:5000/workers/getworkerbyid/'+props.workerid)
...
function BarberReviews(props) {
	...
	useEffect(() => {
	 fetch('http://192.168.8.100:5000/review/getreviewsbyworker/'+props.workerid)
      .then((response) => response.json())
      .then((json) => {
        if (json.success==true) {
...
function WorkerProfileScreenU(props) {
	const worker = props.route.params.workerid;
	useEffect(() => 
	{
		//console.log("eeeeee",worker)
		return () => {};
	}, []);
	return (
		<Tab.Navigator
...
export default WorkerProfileScreenU;
